...
## Complete Example: Email Verification Sign-Up

From [the docs](https://clerk.com/docs/guides/development/custom-flows/authentication/email-sms-otp). Uses email verification codes with password sign-up.
  ...
  return (
    <>
      ...
      <form action={handleSubmit}>
        {/* Collect the emailAddress for verification */}
        <div>
